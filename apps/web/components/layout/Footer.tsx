    ...
    return (
        <div className="flex xl:px-20 sm:py-12 whitespace-nowrap space-y-6 sm:space-y-0 sm:flex-nowrap flex-wrap sm:justify-between container">
            <div className="flex sm:scale-[0.8] scale-[0.7] lg:scale-[1] lg:gap-20 gap-12  justify-between my-auto w-full sm:w-auto text-xl font-semibold tracking-wide leading-8 text-white uppercase max-md:flex-wrap max-md:max-w-full">
                <a href="https://solana.com/" className="flex gap-4 hover:scale-[1.05] transform duration-300 ease-in">
                    <Image
                        loading="lazy"
                        src={solana}
                        alt="image"
                ...
                <a href="https://superteam.fun/" className="flex gap-4 hover:scale-[1.05] transform duration-300 ease-in">
                    <Image
                        loading="lazy"
                        src={superteam}
                        alt="image"
            ...
            <div className="flex lg:gap-20  sm:scale-[0.8] scale-[0.7] lg:scale-[1] w-full justify-between sm:w-auto text-2xl font-medium tracking-wide leading-8 text-zinc-400">
                <a href="https://github.com/Solspeed" className="flex gap-4 py-1 bg-black hover:scale-[1.05] transform duration-300 ease-in">
                    <Image
                        loading="lazy"
                        src={github}
                        alt="image"
                ...
                <a href="https://twitter.com/Sol_canvas" className="flex gap-3 py-px bg-black hover:scale-[1.05] transform duration-300 ease-in">
                    <Image
                        loading="lazy"
                        src={twitter}
                        alt="image"
