...
export default function Interaction1() {
    return (
        <div className="self-stretch rounded-full bg-black shadow-[4px_3px_50px_1px_rgba(134,_122,_210,_0.6)] flex flex-row items-center justify-between  pt-[0.4rem] pb-[0.4rem] sm:py-[1.095rem] box-border gap-[1.25rem] max-w-full text-left text-[2.5rem] text-white  mq450:flex-wrap">
