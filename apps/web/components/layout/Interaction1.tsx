...
export default function Interaction1() {
    return (
        <div className="self-stretch rounded-full bg-black shadow-[4px_3px_50px_1px_rgba(134,_122,_210,_0.6)] flex flex-row items-center justify-between pt-[1.13rem] pb-[1.06rem] pr-[1.38rem] pl-[0.4rem] box-border gap-[1.25rem] max-w-full text-left text-[2.5rem] text-white font-inter mq450:flex-wrap">
            <div className="flex flex-row items-center justify-start">
                <Image
                    ...
                    src={drip}
                />
                <div className="relative tracking-[0.02em] leading-[4.38rem] capitalize font-medium z-[2] mq450:text-[1rem] mq450:leading-[2.63rem] mq1000:text-[2rem] mq1000:leading-[3.5rem]">
                    Drip
                </div>
            </div>
