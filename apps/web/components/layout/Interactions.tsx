...
const Interactions = () => {
  ...
  return (
    <section className="w-[82.19rem] flex flex-col xl:flex-row justify-start pt-[0rem]  pb-[1.44rem] box-border gap-[5.19rem] max-w-full text-left text-[4.38rem] text-white  mq725:gap-[5.19rem] mq725:pb-[7.44rem] mq725:box-border mq450:gap-[5.19rem] px-2">
