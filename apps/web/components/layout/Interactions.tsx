export default function Interactions() {
  return (
    <section className="w-[82.19rem] flex flex-row items-start justify-start pt-[0rem] px-[1.25rem] pb-[11.44rem] box-border gap-[5.19rem] max-w-full text-left text-[4.38rem] text-white font-inter mq725:gap-[5.19rem] mq725:pb-[7.44rem] mq725:box-border mq450:gap-[5.19rem] mq1050:flex-wrap">
      ...
      <div className="flex-1 flex flex-col items-start justify-start gap-[3.44rem] min-w-[24.69rem] max-w-full text-[2.5rem] mq725:gap-[3.44rem] mq725:min-w-full">
      </div>
    </section>
  );
};
