...
export default function Interactions() {
  return (
    <section className="w-[82.19rem] flex flex-col xl:flex-row justify-start pt-[0rem]  pb-[1.44rem] box-border gap-[5.19rem] max-w-full text-left text-[4.38rem] text-white font-inter mq725:gap-[5.19rem] mq725:pb-[7.44rem] mq725:box-border mq450:gap-[5.19rem]">
      ...
      <div className="flex-1 flex xl:flex-col self-end  items-end justify-start  gap-[3.44rem] min-w-[24.69rem] max-w-full text-[2.5rem] mq725:gap-[3.44rem] mq725:min-w-full ">
        <Interaction1 />
        <Interaction2 />
      </div>
    </section>
