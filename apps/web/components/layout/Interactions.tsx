...
const Interactions = () => {
  ...
  return (
    <section className="w-[82.19rem] flex flex-col xl:flex-row justify-start pt-[0rem]  pb-[1.44rem] box-border gap-[5.19rem] max-w-full text-left text-[4.38rem] text-white font-inter mq725:gap-[5.19rem] mq725:pb-[7.44rem] mq725:box-border mq450:gap-[5.19rem] px-2">
      <div className="flex flex-col items-start justify-start gap-[1.44rem] sm:px-0 px-2 min-w-[36.5rem] max-w-full mq725:min-w-full mq1050:flex-1">
        ...
        <div className="w-[35.19rem] tracking-tight relative text-[1.56rem] sm:tracking-[0.02em] leading-[1.88rem] font-medium text-gray-200 inline-block max-w-full mq450:text-[1.25rem] mq450:leading-[1.5rem]">
      ...
      <div className="flex-1 flex flex-col gap-[3.44rem] sm:px-0 px-4 min-w-[24.69rem] max-w-full text-[2.5rem] mq725:gap-[3.44rem] mq725:min-w-full ">
