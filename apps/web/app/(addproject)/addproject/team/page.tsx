    ...
    return (
        <form className="flex flex-col self- sm:mt-24 font-nunito max-w-full mt-10 ">
            ...
            <div className="mt-5 text-[16px] font-nunito font-medium tracking-wide leading-8 text-white text-opacity-50 max-w-full">
                Show world your product design skill of banner and logo.            </div>
            <div className="sm:w-[875px]">
                ...
                <div className="flex  gap-3.5 items-center self-center px-0.5 mt-10 w-full xl:flex-nowrap flex-wrap">
                    <div className="flex items-center justify-center  bg-[#DCA7FB] rounded-[10px] flex-col px-2 aspect-square">
                        ...
                        <div className=" text-xs font-medium tracking-normal leading-8 text-blue-600">
                            <div className="text-black text-nowrap">Drop, Paste here or
                        ...
                        <div className=" mt-2 text-xs tracking-normal leading-3 text-center text-black text-opacity-50">
                            ...
                            <br />
                            JPG, PNG, GIF. Max sie: 5MB
                        </div>
                    </div>
                    <input className="justify-center items-start  placeholder:pl-4 py-4 my-auto text-[18px] font-medium tracking-normal leading-8 bg-[#DCA7FB] rounded-xl border border-solid border-white border-opacity-20 text-black text-opacity-60  placeholder:text-[16px] placeholder:font-nunito placeholder:text-black  placeholder:text-opacity-40"
                ...
                <div className="justify-center text-center items-center self-center px-16 py-4 mt-12 w-full text-xl font-medium tracking-wide leading-8 bg-[#DCA7FB] rounded-xl border border-dashed border-white border-opacity-30 max-w-[879px] text-black text-opacity-80 max-md:px-5 max-md:mt-10 max-md:max-w-full">
                    Add Another Member
                </div>
