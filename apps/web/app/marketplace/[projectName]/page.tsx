...
// import { useProjectContext } from "../../(editproject)/editproject/contextname/page";
...
//     useEffect(() => {
//         // Set the project name when component mounts or params change
//         setProjectName(params.projectName);
//       }, [params.projectName, setProjectName]);
