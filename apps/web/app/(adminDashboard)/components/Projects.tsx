  ...
  return (
    <div className="flex flex-col font-silkscreen p-12 w-full xl:pr-[15vw] bg-black h-screen overflow-hidden">
      ...
      <div className="flex gap-2 self-start mt-3 text-xs whitespace-nowrap pb-4">
        <button
          className={`justify-center px-8 py-2 rounded-md bg-[#1C1C1C] max-md:px-5 ${
      ...
      <div className="overflow-y-scroll">
        {selectedProject ? (
          <div
            ...
            className="px-4 pt-3.5 mt-6 rounded-xl bg-neutral-900 max-md:max-w-full"
          >
          ...
          filteredProjects.map((project) => (
            <div
              key={project.id}
              className="px-4 py-3.5 mt-6 rounded-xl bg-neutral-900 max-md:max-w-full"
            >
              <div className="flex sm:gap-12 gap-5 md:flex-nowrap flex-wrap max-md:gap-0">
                <div className="flex flex-col">
                  <div className="flex grow gap-1.5 self-stretch my-auto text-sm text-red-600 max-md:mt-10">
                    ...
                    <div className="flex flex-col text-base whitespace-nowrap">
                      ...
                      {project.status !== "live" &&
                        project.status !== "rejected" && (
                          <>
                            <button
                              className="justify-center px-6 py-4 text-lime-500 rounded-md bg-[#1C1C1C] max-md:px-5"
                              onClick={() =>
                                updateProjectStatus(project.id, "live")
                              }
                            >
                            ...
                            <button
                              className="justify-center px-8 py-4 mt-3 text-red-600 rounded-md bg-[#1C1C1C] max-md:px-5"
                              onClick={() =>
