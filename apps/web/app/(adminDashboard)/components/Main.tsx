...
const StatCard: React.FC<{ label: string; value: string | number }> = ({
  ...
  return (
    <div className="flex flex-col items-start py-4  pl-3 rounded-xl bg-neutral-900">
      ...
      <div
        className={`mt-11 xl:text-4xl md:text-3xl text-xl font-bold ${
...
const Main: React.FC = () => {
  ...
  return (
    <div className="bg-black overflow-scroll font-silkscreen scroll-smooth p-12 w-full flex justify-between">
